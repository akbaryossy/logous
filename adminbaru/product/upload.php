                    ...
                    <div class="col-md-12">
                        <div class="content-panel">
                            <table class="table table-striped table-advance table-hover">
                                <h4><i class="fa fa-angle-right"></i> Upload News</h4>
                                <!-- start tombol tambah  -->
                                <button><a href="product.php">Tambah product</a></button>
                                ...
                                <!-- <div id="tambah" class="modal fade" role="dialog">
                                            ...
                                            <form action="" method="post" enctype="multipart/from-data">
                                                <div class="modal-body">
                                                    <div class="from-group">
                                                        ...
                                                        <input type="text" name="nm_brg" class="from-control" id="nm_brg" required>
                                                    </div>
                                                    <div class="from-group">
                                                        <label class="control-label" for="hrg_brg"> Title</label>
                                                        <input type="text" name="hrg_brg" class="from-control" id="hrg_brg" required>
                                                </div>
                                                <div class="from-group">
                                                        <label class="control-label" for="stok_brg"> Content</label>
                                                        <input type="text" name="stok_brg" class="from-control" id="stok_brg" required>
                                                </div>
                                                <div class="from-group">
                                                        <label class="control-label" for="gbr_brg"> Picture</label>
                                                        <input type="file" name="gbr_brg" class="from-control" id="gbr_brg" required>
                                                </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><i class="fa fa-bookmark"></i> Published</th> -->
                                            <th> Harga</th>
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $no++?></td>
                                        <td><img src = '../gambar/<?php echo $row['gambar'] ?>' width ='100' height = '100'></td>
                                        <td><?php echo $row['nama']?></td>
                                        <td><?php echo $row['harga']?></td>
                                       
                                        <td><a href="edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit </a> 
                                        <a href="hapusproduct.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                                    </tr>
                                    <?php }} ?>
                                    </tbody>
                            </table>
