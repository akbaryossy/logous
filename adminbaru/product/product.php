	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form method="post" action="tambahproduct.php" class="login100-form validate-form p-l-55 p-r-55 p-t-178" enctype="multipart/form-data">
					<span class="login100-form-title">
						Tambah Admin
					</span>

					<div class="wrap-input100 validate-input m-b-16" data-validate="Please enter gambar">
						<input class="" type="file" name="gambar" placeholder="gambar">
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter Harga">
						<input class="input100" type="text" name="harga" placeholder="harga">
						<span class="focus-input100"></span>
					</div>
